...
export default function DiscoverPage() {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex items-center justify-center py-20">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-600">Loading Discover...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <div
        className="mb-10 bg-white rounded-2xl border border-gray-200 p-5 shadow-sm cal-fade-up"
      ...
      >
        ...
        <div className="relative z-20 flex flex-wrap items-end gap-4 mb-4">
          ...
          {prefsSaving && (
            <span className="text-xs text-gray-400 pb-1">Saving...</span>
          )}
        </div>
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 w-36 p-3 rounded-xl text-left cursor-pointer transition-all duration-200 ${
                      isSelected
                        ...
                        : 'bg-white border border-gray-200/60 text-gray-700 hover:border-blue-300 hover:shadow-md hover:scale-[1.02]'
                    }`}
                  >
                    <div
                      className={`text-xs font-medium mb-0.5 ${isSelected ? 'text-blue-100' : 'text-gray-400'}`}
                    >
                    ...
                    <div
                      className={`text-xs mt-0.5 ${isSelected ? 'text-blue-100' : 'text-gray-500'}`}
                    >
      ...
      <div className="cal-fade-up" style={{ animationDelay: '0.15s' }}>
        <div className="flex items-center gap-2.5 mb-4">
          <span
            className={`inline-flex items-center justify-center w-5 h-5 rounded-full text-xs font-bold ${selectedSlot ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-400'}`}
          >
            2
          </span>
          <h2
            className={`text-sm font-semibold uppercase tracking-wider ${selectedSlot ? 'text-gray-700' : 'text-gray-400'}`}
          >
            Explore suggestions
          </h2>
        </div>
        ...
        {!selectedSlot ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 bg-white rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600">Finding suggestions...</p>
          </div>
        ) : suggestionsError ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 bg-white rounded-2xl border border-gray-200">
            <MapPin className="size-8 text-gray-300 mb-3" />
          ...
          <div>
            ...
            {suggestions.some((s) => s.confidence === 'LOW') && (
              <div className="mb-5 p-3 rounded-xl bg-amber-50/80 border border-amber-200/60 text-amber-800 text-sm flex items-start gap-2">
                ...
                <span>
                  Some suggestions have unknown opening hours and may be closed.
                </span>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {suggestions.map((s, i) => (
                <div
                  key={s.id}
                  className="group bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-lg hover:bg-white/90 transition-all duration-300 cal-fade-up"
                    ...
                    <div className="flex items-center gap-1.5 pt-2 border-t border-gray-100">
                      ...
                      {s.status !== 'SAVED' ? (
                        <button
                          ...
                          disabled={actionLoading === s.id}
                          className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg transition-colors disabled:opacity-50"
                        >
                      ...
                      <button
                        ...
                        disabled={actionLoading === s.id}
                        className="p-1.5 text-gray-400 hover:text-red-500 transition-colors disabled:opacity-50 ml-auto"
                        title="Dismiss"
                      >
